  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
        <header className="mb-8">
            ...
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white">Highway Code</h1>
        ...
        <div className="text-center py-16 border-2 border-dashed border-gray-300 dark:border-slate-700 rounded-lg">
            <p className="text-gray-500 dark:text-gray-400">A searchable Highway Code will appear here.</p>
        </div>
    </div>
  );
};
