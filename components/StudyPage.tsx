            ...
            <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto text-center">
                <header className="mb-8 text-left">
                    <button onClick={() => navigateTo(Page.TopicSelection)} className="flex items-center space-x-2 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors duration-200 group">
                        ...
                        <span className="text-base">Back to Topics</span>
                    </button>
                </header>
    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto">
            <header className="mb-8">
                ...
                <h1 className="text-4xl font-bold text-gray-900 dark:text-white tracking-tight leading-tight">Study: {topic}</h1>
                <p className="text-lg text-gray-500 dark:text-gray-400 mt-2 leading-relaxed">Review questions and explanations at your own pace.</p>
            </header>
            ...
            <main>
                <div className="bg-white dark:bg-slate-800/50 p-6 rounded-xl border border-gray-200 dark:border-slate-700">
                    <div className="flex justify-between items-center text-sm text-gray-500 dark:text-gray-400 mb-6">
                        <span className="font-semibold text-lg text-gray-900 dark:text-white">Question {currentIndex + 1} of {topicQuestions.length}</span>
                    </div>
                            ...
                            <div className="space-y-3">
                                {currentQuestion.options.map((option, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex-shrink-0 font-semibold text-gray-800 dark:text-gray-300 mr-3">{String.fromCharCode(65 + index)}.</div>
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-200 dark:border-slate-700">
                        <h3 className="font-semibold text-base text-gray-800 dark:text-gray-200 mb-2">Explanation</h3>
                        <p className="text-base text-gray-600 dark:text-gray-400 leading-relaxed">{currentQuestion.explanation}</p>
                    </div>
                </div>
